...
{
    public sealed partial class RedisBitmap
    {
        /// <summary>
        ...
        /// </returns>
        public Task<bool> SetBitAsync(string key, uint offset, bool value, CancellationToken cancellationToken = default)
        {
            return base._call.CallConditionAsync(BitmapCommands.SetBit(key, offset, value), "1", cancellationToken);
        }
        ...
        /// <para>偏移处存储的原始位值</para>
        /// </returns>
        public Task<bool> SetBitAsync(string key, long offset, bool value, CancellationToken cancellationToken = default)
        {
            ...
            return this.SetBitAsync(key, (uint)offset, value, cancellationToken);
        }
        ...
        /// <para>存储在此偏移位的值</para>
        /// </returns>
        public Task<bool> GetBitAsync(string key, uint offset, CancellationToken cancellationToken = default)
        {
            return base._call.CallConditionAsync(BitmapCommands.GetBit(key, offset), "1", cancellationToken);
        }
        ...
        /// <para>存储在此偏移位的值</para>
        /// </returns>
        public Task<bool> GetBitAsync(string key, long offset, CancellationToken cancellationToken = default)
        {
            if (offset < 0) throw new RedisException($"The offset passed in is {offset}, offset cannot be less than 0");
            if (offset > uint.MaxValue) throw new RedisException($"The offset passed in is {offset}, the maximum value of offset is {uint.MaxValue}");
            return this.GetBitAsync(key, (uint)offset, cancellationToken);
        }
        ...
        /// </returns>
        public Task<long> BitPosAsync(string key, bool bit, long? start = null, long? end = null, CancellationToken cancellationToken = default)
        {
            return base._call.CallNumberAsync<long>(BitmapCommands.BitPos(key, bit, start, end), ResultType.Int64, cancellationToken);
        }
        ...
        /// <para>如果Key是空的, 或Key不存在, 或者bit为1, 但Key里面没有1, 都返回-1</para>
        /// </returns>
        public Task<long> BitPosAsync(string key, bool bit, ByteBit bb, long? start = null, long? end = null, CancellationToken cancellationToken = default)
        {
            return base._call.CallNumberAsync<long>(BitmapCommands.BitPos(key, bit, start, end, bb), ResultType.Int64, cancellationToken);
        }
        ...
        /// </returns>
        public Task<long> BitOpAsync(BitOperation bitOperation, string destkey, string[] keys, CancellationToken cancellationToken = default)
        {
            return base._call.CallNumberAsync<long>(BitmapCommands.BitOp(bitOperation, destkey, keys), ResultType.Int64, cancellationToken);
        }
        ...
        /// </returns>
        public Task<long> BitCountAsync(string key, long? start = null, long? end = null, CancellationToken cancellationToken = default)
        {
            return base._call.CallNumberAsync<long>(BitmapCommands.BitCount(key, start, end), ResultType.Int64, cancellationToken);
        }
        ...
        /// <para>字符串中设置的位数, 不存在的Key或空字符串返回0</para>
        /// </returns>
        public Task<long> BitCountAsync(string key, ByteBit bb, long? start = null, long? end = null, CancellationToken cancellationToken = default)
        {
            return base._call.CallNumberAsync<long>(BitmapCommands.BitCount(key, start, end, bb), ResultType.Int64, cancellationToken);
        }
        ...
        public Task<long?[]?> BitFieldAsync(string key, IBitFieldArg arg, CancellationToken cancellationToken = default)
#else
        public Task<long?[]> BitFieldAsync(string key, IBitFieldArg arg, CancellationToken cancellationToken = default)
#endif
        {
#if NET8_0_OR_GREATER
            return this.BitFieldAsync(key, [arg] , cancellationToken);
#else
            return this.BitFieldAsync(key, new IBitFieldArg[] { arg }, cancellationToken);
#endif
        }
        ...
        /// </returns>
#if NET5_0_OR_GREATER || NETSTANDARD2_1_OR_GREATER
        public Task<long?[]?> BitFieldAsync(string key, IBitFieldArg[] args, CancellationToken cancellationToken = default)
#else
        public Task<long?[]> BitFieldAsync(string key, IBitFieldArg[] args, CancellationToken cancellationToken = default)
#endif
        {
            return base._call.CallNullableStructArrayAsync<long>(BitmapCommands.BitField(key, args), ResultType.Array | ResultType.Int64 | ResultType.Nullable, cancellationToken);
        }
        ...
        /// </returns>
#if NET5_0_OR_GREATER || NETSTANDARD2_1_OR_GREATER
        public Task<long[]?> BitField_RoAsync(string key, IBitFieldArg[] gets, CancellationToken cancellationToken = default)
#else
        public Task<long[]> BitField_RoAsync(string key, IBitFieldArg[] gets, CancellationToken cancellationToken = default)
#endif
        {
            return base._call.CallStructArrayAsync<long>(BitmapCommands.BitField_Ro(key, gets), ResultType.Array | ResultType.Int64, cancellationToken);
        }
        ...
        /// <para>每个条目是在同一位置给出的子命令的相应结果</para>
        /// </returns>
        public Task<long> BitField_RoAsync(string key, IBitFieldArg get, CancellationToken cancellationToken = default)
        {
#if NET8_0_OR_GREATER
            return base._call.CallNumberAsync<long>(BitmapCommands.BitField_Ro(key, [get]), ResultType.Int64, cancellationToken);
#else
            return base._call.CallNumberAsync<long>(BitmapCommands.BitField_Ro(key, new IBitFieldArg[] { get }), ResultType.Int64, cancellationToken);
#endif
        }
    }
}
