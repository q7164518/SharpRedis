...
namespace SharpRedis
{
    ...
    {
        internal RedisHyperLogLog(BaseCall call) : base(call)
        {
        }
        ...
        /// </returns>
        public bool PFAdd(string key, string element, CancellationToken cancellationToken = default)
        {
            return base._call.CallCondition(HyperLogLogCommands.PFAdd(key, element), "1", cancellationToken);
        }
        ...
        /// <para>false: 没有元素被更改</para>
        /// </returns>
        public bool PFAdd(string key, byte[] element, CancellationToken cancellationToken = default)
        {
            return base._call.CallCondition(HyperLogLogCommands.PFAdd<byte[]>(key, element), "1", cancellationToken);
        }
        ...
        /// <para>false: 没有元素被更改</para>
        /// </returns>
        public bool PFAdd(string key, string[] elements, CancellationToken cancellationToken = default)
        {
            return base._call.CallCondition(HyperLogLogCommands.PFAdd(key, elements), "1", cancellationToken);
        }
        ...
        /// <para>false: 没有元素被更改</para>
        /// </returns>
        public bool PFAdd(string key, byte[][] elements, CancellationToken cancellationToken = default)
        {
            return base._call.CallCondition(HyperLogLogCommands.PFAdd(key, elements), "1", cancellationToken);
        }
        ...
        public long PFCount(string key, string[]? keys = null, CancellationToken cancellationToken = default)
#else
        public long PFCount(string key, string[] keys = null, CancellationToken cancellationToken = default)
#endif
        {
            return base._call.CallNumber<long>(HyperLogLogCommands.PFCount(key, keys), ResultType.Int64, cancellationToken);
        }
        ...
        /// <returns></returns>
#if NET5_0_OR_GREATER || NETSTANDARD2_1_OR_GREATER
        public bool PFMerge(string destkey, string? sourceKey = null, string[]? sourcekeys = null, CancellationToken cancellationToken = default)
#else
        public bool PFMerge(string destkey, string sourceKey = null, string[] sourcekeys = null, CancellationToken cancellationToken = default)
#endif
        {
            return base._call.CallCondition(HyperLogLogCommands.PFMerge(destkey, sourceKey, sourcekeys), "OK", cancellationToken);
        }
    }
}
